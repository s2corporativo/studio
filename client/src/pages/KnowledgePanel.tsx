  ...
  return <div className="grid gap-6 xl:grid-cols-[.8fr_1.2fr]">
    <div className="space-y-5">
      ...
      <form onSubmit={submitFile} className="saas-card p-5 sm:p-6">
        ...
        <div className="mt-5 space-y-3">
          <input type="file" accept="application/pdf,image/jpeg,image/png,image/webp,.doc,.docx" onChange={event => setFile(event.target.files?.[0] ?? null)} className="block w-full text-xs text-slate-400 file:mr-3 file:rounded-lg file:border-0 file:bg-violet-500/10 file:px-3 file:py-2 file:text-xs file:font-semibold file:text-violet-300" />
