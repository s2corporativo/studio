...
const networks = [
  { name: "Instagram", icon: Instagram, state: "Conector ativo", detail: "OAuth oficial + publicação + agenda", tone: "text-fuchsia-300 bg-fuchsia-400/10" },
  { name: "Facebook", icon: Facebook, state: "Próxima integração", detail: "Arquitetura preparada para Meta Graph", tone: "text-blue-300 bg-blue-400/10" },
  { name: "LinkedIn", icon: Linkedin, state: "Próxima integração", detail: "Página empresarial e conteúdo profissional", tone: "text-sky-300 bg-sky-400/10" },
  { name: "TikTok", icon: Video, state: "Próxima integração", detail: "Vídeo curto e conteúdo vertical", tone: "text-cyan-300 bg-cyan-400/10" },
];

export default function NetworkHub() {
  return <div className="space-y-7">
    <section className="saas-hero rounded-3xl p-6 sm:p-8"><div className="saas-eyebrow"><Network className="h-3.5 w-3.5" /> Central de distribuição</div><h2 className="mt-4 text-3xl font-semibold tracking-tight text-white sm:text-4xl">Conecte as contas sem compartilhar senhas.</h2><p className="mt-3 max-w-3xl text-sm leading-6 text-slate-400">Cada rede deve usar OAuth e tokens criptografados. O Instagram já possui fluxo funcional no projeto; os demais conectores aparecem como expansão controlada, sem simular integração inexistente.</p></section>
