    ...
    <div className="p-5 sm:p-7">
      ...
      {isFormOpen && <form onSubmit={submit} className="mb-7 border border-[#c99550]/25 bg-[#07150f]/50 p-5 sm:p-6">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <label className="space-y-2 text-xs font-medium text-[#d8dfd7]"><span>Nome de exibição</span><Input required maxLength={160} value={draft.displayName} onChange={event => setDraft(current => ({ ...current, displayName: event.target.value }))} placeholder="Ex.: De Paula Teixeira Advocacia" className="editorial-input" /></label>
