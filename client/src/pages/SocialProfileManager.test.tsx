...
vi.mock("@/lib/trpc", () => ({
  trpc: {
    ...
    socialStudio: {
      socialProfiles: { useQuery: () => ({ data: [{ id: 17, network: "instagram", displayName: "S2 Studio", handle: "s2studio.adv", profileUrl: "https://www.instagram.com/s2studio.adv/", externalAccountId: null, notes: null, state: "pending_oauth" }] }) },
